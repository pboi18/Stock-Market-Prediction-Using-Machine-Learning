...
If you want to throw away the instruction manual and play immediately, 
cd Users/User/Desktop/Stock Market Prediction Using Machine Learning
```
...
This project was originally based on Sentdex's excellent [machine learning tutorial](https://www.youtube.com/playlist?list=PLQVvvaa0QuDd0flgGphKCej-9jp-QdzZ3), but it has since evolved far beyond that and the code is almost completely different. 
